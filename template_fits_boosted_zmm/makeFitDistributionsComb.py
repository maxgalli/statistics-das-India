...
parser.add_argument('-c', '--category', type=str, default='zmm', choices=["zmm","zjet"], help='categories');
...
parser.add_argument('-r', '--rebin-factor', type=int, default=1, help='rebin factor for the distribution');
